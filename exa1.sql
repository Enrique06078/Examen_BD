...
Execute pa_insert (3,190020069,'Alexis','Chavez','Quiñones','Gastronomia','8G12',8, 'C', 83);
...
Execute pa_insert (10,190020077,'Rafael','Valencia','Hernández','Gastronomia','8G12',8, 'C', 84);
/*-----------------------------------ENERGIAS RENOVABLES---------------------------------------------------*/
Execute pa_insert (11,185010032,'Zaira Elisa','Castillo','Mejia','Energias Renovables','8E11',8,'I',75);
Execute pa_insert (12,225020008,'Bitia','Ramales','López','Energias Renovables','2ER11',2,'I',95);
Execute pa_insert (13,225022008,'Eduardo','Martínez','Cazares','Energias Renovables','8E11',8,'I',86);
Execute pa_insert (14,195020008,'Juan','Reyes','Barrios','Energias Renovables','8E11',8,'I',87);
Execute pa_insert (15,195020004,'Jesús Uriel','Valdez','Bobadilla','Energias Renovables','7E11',7,'I',88);
...
execute pa_insert (24,202020036,'Fernanda','Santana','Patiño','Administracion','5AD11',5,'D',90);
...
/*-----------------------------------SISTEMAS AUTOMOTRIZ---------------------------------------------------*/
execute pa_insert (31,219010005,'David', 'Muñoz','Rodríguez', 'Sistemas Automotrices','5SA11',5,'E',81);
...
execute pa_insert (45,214002022,'Manuel Isaac', 'Cabañas','Pineda', 'Ingenieria Ambiental','4A11',4,'H',85);
...
execute pa_insert (61,216020029,'Moisés Enrique', 'Lucero','treviño', 'Ingeniería en Sistemas Computacionales','3S21',3,'B',70);
execute pa_insert (62,216020093,'Jesus Ezequiel', 'Flores','Cruz', 'Ingeniería en Sistemas Computacionales','5S11',5,'A',75);
execute pa_insert (63,206020058,'Judith Metabel', 'Ramales','Lopez', 'Ingeniería en Sistemas Computacionales','6S11',6,'A',95);
execute pa_insert (64,186010106,'Orlando', 'Chavero','Mejia', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',80);
execute pa_insert (65,206010031,'Ariana Montserrat', 'Saavedra','Luis', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',85);
execute pa_insert (66,196020150,'Jose Leonardo', 'Gonzalez','Valadez', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',93);
execute pa_insert (67,206010009,'Perla Ivonne', 'Cordoba','Morales', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',92);
execute pa_insert (68,196020039,'Marcos Aaron', 'Lopez','Garcia', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',88);
execute pa_insert (69,196020018,'Luis Abraham', 'Lopez','Garcia', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',90);
execute pa_insert (70,206010017,'Diego', 'Hernandez','Guzman', 'Ingeniería en Sistemas Computacionales','7S11',7,'B',90);
/*-----------------------------------TICS---------------------------------------------------*/
execute pa_insert (71,207010006,'Angel Gabriel', 'Hernandez','Garcia', 'Ingeniería en Tecnologias de la Información y Comunicaciones','7T11',7,'L',93);
execute pa_insert (72,207010014,'Pamela', 'Perez','Allala', 'Ingeniería en Tecnologias de la Información y Comunicaciones','7T11',7,'L',93);
execute pa_insert (73,227020025,'Yocelin', 'Hernandez','Hernandez', 'Ingeniería en Tecnologias de la Información y Comunicaciones','2T11',2,'L',86);
execute pa_insert (74,227020010,'Beatriz', 'Gonzalez','Gonzalez', 'Ingeniería en Tecnologias de la Información y Comunicaciones','2T11',2,'L',90);
execute pa_insert (75,227020031,'Iris Jazmin', 'Patricio','Martinez', 'Ingeniería en Tecnologias de la Información y Comunicaciones','2T11',2,'L',86);
execute pa_insert (76,217020020,'Jorge', 'Avila','Loranca', 'Ingeniería en Tecnologias de la Información y Comunicaciones','4T11',4,'E',75);
execute pa_insert (77,227020022,'Josué', 'Manjarez','Zumoza', 'Ingeniería en Tecnologias de la Información y Comunicaciones','4T11',4,'E',84);
execute pa_insert (78,227020026,'Ángel', 'Garcia','Emily', 'Ingeniería en Tecnologias de la Información y Comunicaciones','4T11',4,'E',99);
execute pa_insert (79,227020021,'Maira Jocelyn', 'Navarro','Garcia', 'Ingeniería en Tecnologias de la Información y Comunicaciones','4T11',4,'E',70);
execute pa_insert (80,227020002,'Fernando', 'Báez','Valencia', 'Ingeniería en Tecnologias de la Información y Comunicaciones','8T11',8,'E',90);
/*-----------------------------------CONTADOR PUBLICO---------------------------------------------------*/
execute pa_insert (81,191020117,'Angel','Omez','Evangelista','Contaduria pública','8C12',8,'I',80);
execute pa_insert (82,191020051,'Rocío','Lopez', 'De la Cruz','Contaduria pública','8C12',8,'I',80);
execute pa_insert (83,191020082,'Anabelin','Solano','Herrera','Contaduria pública','8C12',8,'I',90);
execute pa_insert (84,191020037,'Saray','Galindo','Jimenez','Contaduria pública','8C12',8,'I',90);
execute pa_insert (85,213030022,'Fernando','Guzman','Sanchez','Contaduria pública','4C11',4,'I',81);
execute pa_insert (86,213020134,'Juan','Miran','Artega','Contaduria pública','4C11',4,'I',89);
execute pa_insert (87,213020221,'Estefania','Ruiz','Ocote','Contaduria pública','4C11',4,'I',85);
execute pa_insert (88,213020032,'Michelle','Garcia','Hernandez','Contaduria pública','2C11',2,'I',83);
execute pa_insert (89,213020082,'Aranza','Romero','Salas','Contaduria pública','2C11',2,'I',80);
execute pa_insert (90,213020062,'Fernana','Esionoza','Rodriguez','Contaduria pública','2C11',2,'I',88);
...
execute insert_profe (1,'Alberto','Dorado','Mendez','Ing. Industrial','Matemáticas','2I12');
...
execute insert_profe (4,'Jose','Flores','Flores','Ing. Tecnologias de la Información y Comunicaciones','Autómata Programable','6I11');
execute insert_profe (5,'Jose','Flores','Flores','Ing. Tecnologias de la Información y Comunicaciones','Redes de computadora','7T11');
execute insert_profe (6,'Gustavo Moisés','Romero','Gonzalez','Ing. Tecnologias de la Información y Comunicaciones','Sistemas Operativos I','5T11');
execute insert_profe (7,'Gustavo Moisés','Romero','Gonzalez','Ing. Sistemas Computacionales','Taller de Sistemas Operativos','6S11');
execute insert_profe (8,'Gustavo Moisés','Romero','Gonzalez','Ing. Sistemas Computacionales','Taller de Sistemas Operativos','6S12');
execute insert_profe (9,'Gustavo Moisés','Romero','Gonzalez','Ing. Sistemas Computacionales','Taller de Sistemas Operativos','6S21');
execute insert_profe (10,'Gustavo Moisés','Romero','Gonzalez','Ing. Tecnologias de la Información y Comunicaciones','Sistemas Operativos II','6T11');
execute insert_profe (11,'Gustavo Moisés','Romero','Gonzalez','Ing. Tecnologias de la Información y Comunicaciones','Bases de Datos Distribuidas','7T11');
...
execute insert_profe (18,'Adriana Arisbel','Ortega','Reyes','Ing. Industrial','Cálculo integral','2I12');
execute insert_profe (19,'Adriana Arisbel','Ortega','Reyes','Ing. Industrial','Cálculo integral','2I11');
execute insert_profe (20,'Adriana Arisbel','Ortega','Reyes ','Ing. Sistemas Automotrices','Ecuaciones Diferenciales','4SA11');
execute insert_profe (21,'Adriana Arisbel','Ortega','Reyes ','Ing. Sistemas Automotrices','Álgebra Lineal ','2SA21');
execute insert_profe (22,'Adriana Arisbel','Ortega','Reyes','Ing. Tecnologias de la Información y Comunicaciones','Álgebra Lineal','1T11');
execute insert_profe (23,'Camarillo','Cadena','Mendrano','Ing. Ambiental','Calculo integral','3A12');
execute insert_profe (24,'César Alejandro','López','Castañeda','Ing. Sistemas Computacionales','Ingenieria de Software','6S11');
execute insert_profe (25,'César Alejandro','López','Castañeda','Ing. Sistemas Computacionales','Ingenieria de Software','6S12');
execute insert_profe (26,'César Alejandro','López','Castañeda','Ing. Sistemas Computacionales','Programacion Lógica y funcional','8S12');
execute insert_profe (27,'Ariana','Lozada','Pérez','Lic. Administracion','Taller de Administracion','1AD11');
execute insert_profe (28,'Ana Lilia','Mendizabal','Garduño','Lic. Administracion','Mercadotecnia','4AD11');
...
execute insert_profe (39,'Julio Cesar','Muñoz','Perez','Ing. Energias Renovables','Algebra Lineal','2E11');
...
execute Insert_Profe (51,'Pedro Abel','Rojas','Rivera','Ing. Tecnologias de la Información y Comunicaciones','Estructuras Y Od','3T11');
execute Insert_Profe (52,'Nayely Beatriz','Gonzalez','Contreras','Ing. Tecnologias de la Información y Comunicaciones','Admin General','3T11');
execute Insert_Profe (53,'Jose Luis','Villareal','Lopez','Ing. Tecnologias de la Información y Comunicaciones','Electricidad','3T11');
...
execute Insert_Profe (57,'Alicia','Mendoza','Garduño','Ing. Sistemas Automotrices','Circuitos','5SA12');
execute Insert_Profe (58,'Zharahi','Castaño','Hernandez','Ing. Contaduria Pública','Calculo','6C11');
execute Insert_Profe (59,'Omar','Garcia','Jimenez','Ing. Contaduria Pública','Estadistica','3C12');
execute Insert_Profe (60,'Roberto','Lopez','Castro','Ing. Contaduria Pública','Tutoria','4C11');
